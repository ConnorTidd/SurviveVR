...
namespace DigitalRuby.LightningBolt
{
    ...
    public class LightningBoltScript : MonoBehaviour
    {
        ...
        public void Trigger()
        {
            ...
            {
                point1 = StartObject.transform.position + StartPosition;
            }
            if (EndObject == null)
            {
                point2 = EndPosition;
            ...
            {
                point2 = EndObject.transform.position + EndPosition;
            }
            startIndex = 0;
            GenerateLightningBolt(point1, point2, Generations, Generations, 0.0f);
            UpdateLineRenderer();
        }
        ...
        public void setBothPoints(GameObject point1, GameObject point2) 
        {
